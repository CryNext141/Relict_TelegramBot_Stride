    ...
    public class BotService : IBotService
    {
        ...
        private async Task HandleCallback(CallbackQuery cb, CancellationToken ct, bool answer = true)
        {
            ...
            if (cb.Data.StartsWith("report:", StringComparison.Ordinal))
            {
                ...
                if (parts.Length < 3)
                {
                    await SafeAnswerCallbackQuery(cb.Id, ct, "Невірний формат даних для репорту.", showAlert: true);
                    return;
                }
        ...
        "«Stride» — це чат-бот, який є частиною Системи Оповіщення Наслення про Викрадення Дітей «Relict».\n\n" +
        "🔹 **Для чого потрібен бот «Stride»?**\n" +
        "Бот дозволяє швидко отримувати інформацію про актуальні випадки викрадення дитини та надсилати свідчення, якщо Ви стали свідком викрадення. \n\n" +
        "🔹 **Що таке підписка на сповіщення?**\n" +
        "Підписка на сповіщення дозволяє отримувати в реальному часі повідомлення про нові випадки викрадення в залежності від Вашого місця проживання.\n\n" +
        "🔹 **В якийх містах України підтримується підписка на сповіщення?**\n" +
        "Підписка на сповіщення доступна тільки в великих містах України (Львів, Івано-Франківськ, і тд.).\n\n" +
        "🔹 **Як мені підписатися на сповіщення?**\n" +
        "Для цього Вам необхідно натиснути на кнопку «Підписка» в головному меню бота. Опісля перейти в розділ «Обрати місто», і вже в даному розділі обрати місто.\n\n" +
        "🔹 **Я став свідком викрадення, або володію важливою інформацією. Як мені повідомити це?**\n" +
        "Для цього Вам необхідно натиснути кнопку «Повідомити інформацію» та слідувати за кроками заповнення даних.\n\n" +
        "🔹 **Чи можна залишатися анонімним при надсиланні свідченнь?**\n" +
        ...
        "Так, Ви можете вводити зміни, відписуватися або додавати нові міста у розділі «Мої міста».\n\n";
